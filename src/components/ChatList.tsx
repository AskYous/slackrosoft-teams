...
import { ScrollArea } from "./ui/scroll-area"; // Corrected import path assuming it's in ui
...
export const ChatList: FC<ChatListProps> = ({ chats, title, onSelectChat, selectedChatId }) => {
  return (
    ...
    <div className="w-80 h-full border-r bg-primary text-accent flex flex-col">
      {/* Header */}
